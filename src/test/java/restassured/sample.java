...
import commonFunction.CommonJavaFunction;
import commonFunction.CommonJavaFunctionImp;
import courseList.CourseList;
import courseList.CourseListImp;
import timeTable.TimeTableImp;
import timeTable.Timetable;
import yearList.YearList;
import yearList.YearListImp;
...
public class sample {
	...
	public static void main(String[] args) {
		try {
			CourseList courseList = new CourseListImp();
			YearList yearList = new YearListImp();
			Timetable timetable = new TimeTableImp();
			...
			CommonJavaFunction fun=new CommonJavaFunctionImp();
